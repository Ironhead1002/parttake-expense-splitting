                ...
                <div class="flex flex-col">
                    <!-- Stats Row Starts Here -->
                        ...
                        $sql="SELECT event.event_name,event.event_id
                              ...
                              ON event.event_id=event_members.event_id where event.event_status = 'ended' and event_members.user_id = $id";
                        ...
                        while($result = mysqli_fetch_array($quary))
                        {
                            ...
                            echo "<a href=\"past_event_exp.php\">
                                    ...
                                    <div class=\"shadow-lg bg-red-vibrant border-l-8  hover:bg-red-vibrant-dark border-red-vibrant-dark mb-2 p-2  md:w-1/4 mx-2 event-div\">
                                        <div class=\"p-4 flex flex-col\">
                                            <a href=\"past_event_exp.php?data=".$e_unique_event_id."\" class=\"no-underline text-white text-2xl\">"
                                                .$d_var_event_name."
                                            </a>
                                        </div>
                                        <div class=\"p-4\">
                                            <a href=\"past_event_exp.php\" class=\"no-underline text-white text-lg align-items-end align-text-bottom\">"
                                                .$total_expense.
                                            "</a>
                                        </div>
                                    </div>
